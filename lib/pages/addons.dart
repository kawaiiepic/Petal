            ...
            Expanded(
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: Row(
                    mainAxisSize:
                        MainAxisSize.min, // important to avoid stretching
                    children: [
                      IconButton(
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedContainer(
      ...
      transform: widget.isDragging
          ? Matrix4.identity().scaledByDouble(0, 0, 0, 1.03)
          : Matrix4.identity(),
      child: Opacity(
          ...
          child: ExpansionTile(
            ...
            subtitle: Wrap(
              ...
              children: widget.addon.resources.map((resource) {
                final enabled = widget.addon.enabledResources.contains(
                  resource.name,
                );
            ...
            children: [
              Padding(
                ...
                child: SelectableText(
                  JsonEncoder.withIndent('  ').convert(widget.addon.manifest),
